...
var id_arr = ["HFqcC","M^jf!","NqpbR","Vs_sA","WFvvk","W$e#u","W}[sc","XtT?@","YH[Xn","Y~Jjx","?qZOY","]DRmy","^WXig","^XoC~","!_~eZ","!tTsJ","aJAvA","cBmcz","cK~Qr","d_xvy","hA}K#","iKiwd","kqjiJ","%$zkY","mGvkp","mJ?Rr","wbzf}","xatf$","easyid","admin"];
var pw_arr = ["e4b1cec63d16", "c53d2fd81a66", "06d6afcf88e8", "f2a6f9460ab3", "a2116658d876", "087c55dc81c9", "a4aa1a453356", "e895a8fcc144", "3233f5dcb9b5", "409d5bcb7528", "895b7463fc49", "7ebdabe8cf34", "67cb1f0d6e7f", "a566682f8df2", "3f84d0cbb6bb", "1279b29fcc55", "5d0c1c8b3750", "110e1b6c6237", "2e3a00b7cbec", "1df7ad1e5924", "391b76ef2a95", "40239ef79031", "6d251af1e679", "55051fed04d4", "f485e8e2c2c6", "ad147a1f0d34", "704e20c0e8f5", "e6e4c0de9471", "easykeyword", "master"];
...
var login_date = "2016-09-13T02:00:00";

var sc_arr = [["40", "40", "80", "0", "60", "60", "100", "0", "40", "40", "20", "0", "60", "0", "80", "40", "80", "60", "80", "40", "80", "0", "80", "80", "40", "80", "80", "80"],
              ["32", "2", "54", "10", "21", "53", "29", "3", "4", "0", "5", "0", "43", "0", "8", "27", "25", "13", "56", "1", "11", "0", "33", "27", "64", "24", "60", "0"],
              ["80", "100", "100", "60", "80", "80", "40", "40", "40", "80", "40", "0", "80", "0", "40", "40", "0", "100", "80", "20", "100", "0", "100", "40", "60", "60", "80", "100"],
              ["20", "40", "40", "40", "40", "40", "40", "20", "40", "40", "40", "-25", "20", "20", "20", "60", "40", "40", "40", "20", "40", "20", "40", "60", "40", "80", "40", "40"],
              ["40", "80", "80", "20", "40", "60", "40", "0", "0", "60", "0", "20", "40", "-25", "20", "40", "60", "60", "40", "20", "60", "20", "60", "-25", "20", "40", "60", "60"],
              ["60", "80", "80", "0", "100", "0", "0", "80", "20", "100", "-25", "0", "60", "20", "-25", "-25", "60", "60", "80", "60", "60", "-25", "60", "20", "40", "20", "60", "40"],
              ["12", "0", "60", "13", "26", "70", "20", "2", "0", "2", "-25", "0", "13", "0", "1", "14", "6", "8", "86", "0", "27", "0", "17", "10", "31", "2", "78", "11"]];
var exam_name = ["수시고사 #1 (힘)", "중간고사", "수시고사 #2 (지점반력)", "수시고사 #3 (정정보의 해석)", "수시고사 #4 (정정골조의 해석)", "수시고사 #5 (정정트러스의 해석)", "기말고사"];
var average = ["60", "22", "63", "38", "40", "48", "19"];
var score_date = ["2016-09-28T02:00:00", "2016-10-25T02:00:00", "2016-11-01T02:00:00", "2016-11-09T02:00:00", "2016-11-23T02:00:00", "2016-12-07T02:00:00", "2016-12-207T02:00:00"];
var cur_exam_id = 6; // 0="수시고사 #1 (힘)", 1="중간고사", 2="수시고사 #2 (지점반력)", 3="수시고사 #3 (정정보의 해석)", 4="수시고사 #4 (정정골조의 해석)", 5="수시고사 #5 (정정트러스의 해석)", "기말고사"
...
function login() {
    ...
    for (var i = 0; i < id_arr.length; i++)
    {
        if ((id == id_arr[i]) && (pw == pw_arr[i])) // in case of success
        {
            ...
            {
                var tgt_date = Date.parse(score_date[cur_exam_id].replace(/\r?\n|\r/g, "")); // remove new line character; 2016.09.07 am 9:00
                var cur_date = new Date($.now());
...
function show_score(p_id, p_idx) {
    $("#li_id").text("아이디 : " + p_id);
    $("#li_exam_name").text("시험 : " + exam_name[cur_exam_id]);
    $("#li_score").text("점수 : " + sc_arr[cur_exam_id][p_idx]);
    $("#li_avg").text("평균 : " + average[cur_exam_id]);
    $("#div_login").hide();
    $("#main_view").show();
}
